...
module.exports.run = async function({ api, event, args }) {
    ...
    try {
        ...
        const botOwnerProfileLink = "https://www.facebook.com/itssmekylebaitit"; // Replace this with the bot owner's Facebook profile link
        const messageWithLink = `${data.gpt4}\n𝐂𝐫𝐞𝐝𝐢𝐭𝐬 𝐭𝐨 𝐭𝐡𝐞 𝐛𝐨𝐭 𝐜𝐫𝐞𝐚𝐭𝐨𝐫:  ${botOwnerProfileLink}`;
